  ...
  Player: function (browser) {
    browser
      ...
      .waitForElementPresent(
        'div.player div.player-progress-container button.player-progress-button.medium:nth-child(2)'
      ) //Rewind 10 seconds
      ...
      .waitForElementPresent(
        'div.player div.player-progress-container button.player-progress-button.medium:nth-child(4)'
      ) //Fast-forward 30 seconds
      .waitForElementPresent(
        'div.player div.player-progress-container button.player-progress-button.medium:nth-child(5)'
      ) //Double right
      ...
      .waitForElementPresent(
        'div.player div.player-buttons-container:nth-child(3) button.player-option-button.small:nth-child(3)'
      ) //Make Clip
      .waitForElementPresent(
        'div.player div.player-buttons-container:nth-child(3) .player-control-volume-wrapper button.player-option-button.small:nth-child(3)'
      ) //Fullscreen
      ...
      .waitForElementPresent(
        'div.player-full-view div.player-progress-container button.player-progress-button.medium:nth-child(2)'
      ) //Rewind 10 seconds
      //nth-child(3) = Play button but has different hierarchy
      ...
      .waitForElementPresent(
        'div.player-full-view div.player-progress-container button.player-progress-button.medium:nth-child(4)'
      ) //Fast-forward 30 seconds
      .waitForElementPresent(
