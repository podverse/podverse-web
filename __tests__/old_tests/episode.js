...
module.exports = {
  ...
  'Episode Page': function (browser) {
    browser
      .waitForXpathPresent(
        '//article[contains(text(), "The Americans are coming, but will the war be over by the time they get there? Germany throws everything into a last series of stupendous attacks in the West while hoping to avoid getting burned by a fire in the East they helped fan.")]'
      )
      .testSharedMetaTags()
      .testPageMetaTags(
