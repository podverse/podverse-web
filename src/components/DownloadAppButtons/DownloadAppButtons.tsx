...
export const DownloadAppButtons = () => {
  return (
    <div className='download-app-buttons'>
      ...
      <a className='get-it-on-google-play no-radius' href={PV.Config.APP_GET_IT_ON_GOOGLE_PLAY_URL}>
        <img alt='Get it on Google Play' src={PV.RoutePaths.web.googlePlayStoreBadge} />
      </a>
      <a
