...
type ArtistHeaderNotificationButtonProps = {
  channel: DTOChannel;
}

export const ArtistHeaderNotificationButton: React.FC<ArtistHeaderNotificationButtonProps> = ({ channel }) => {
  ...
  const label = isSubscribed
    ? tFeatures("notifications.disable_notifications_for_this_artist")
    : tFeatures("notifications.enable_notifications_for_this_artist");
