...
export interface Config {
  ...
  IMAGE_ORIGIN_REWRITE_FROM?: string
  IMAGE_ORIGIN_REWRITE_TO?: string
...
export default () => {
  ...
  const config: Config = {
    ...
    IMAGE_ORIGIN_REWRITE_FROM: publicRuntimeConfig.IMAGE_ORIGIN_REWRITE_FROM,
    IMAGE_ORIGIN_REWRITE_TO: publicRuntimeConfig.IMAGE_ORIGIN_REWRITE_TO,
